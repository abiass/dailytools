  ...
  return (
    <div className="p-6 max-w-xl mx-auto flex flex-col items-center dark:text-white">
      <div className="w-full bg-white dark:bg-gray-900 shadow-lg p-6 rounded-xl flex flex-col gap-6">
        ...
        {/* Texto central */}
        <div className="text-center text-bold bg-yellow-100 px-4 py-2 rounded mb-4 dark:bg-orange-300 text-gray-900">
          Assim como
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center sm:space-x-4 mb-4 w-full">
          ...
          <span className="bg-green-100 px-6 py-2 rounded-full text-center mb-2 sm:mb-0 mt-2 dark:bg-green-200 text-gray-900">
            {/* Resultado */}
            {resultado !== null && (
